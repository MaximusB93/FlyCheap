...
namespace FlyCheap.Migrations
{
    ...
    [Migration("20231112085701_Initial")]
            ...
            modelBuilder.Entity("FlyCheap.Model.AirportsJson", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("AirportsId"));
            ...
            modelBuilder.Entity("FlyCheap.Model.NameTranslations", b =>
                {
                    ...
                    b.ToTable("DataNameTranslations");
                });
